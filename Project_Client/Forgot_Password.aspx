<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Forgot_Password.aspx.cs" Inherits="Project_Client.Forgot_Password" %>
...
<body>
    ...
    <h1>Password Recovery&nbsp; </h1>
        ...
        <p class="auto-style4">SECURITY ANSWER:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBox9" runat="server"></asp:TextBox>
            ...
            <p class="auto-style4">NEW PASSWORD:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox11" runat="server" OnTextChanged="TextBox11_TextChanged"></asp:TextBox>
        </p>
                <p class="auto-style4">RE ENTER NEW PASSWORD&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox12" runat="server"></asp:TextBox>
        &nbsp;<asp:CompareValidator ID="CompareValidator1" runat="server" Display="Dynamic" ForeColor="Red" ControlToCompare="TextBox11" ControlToValidate="TextBox12" ErrorMessage="*Mismatch"></asp:CompareValidator>
        </p>
                <p class="auto-style4">
