...
<asp:TextBox ID="TextBox3"  placeholder="Your Email *" runat="server" OnTextChanged="TextBox3_TextChanged" Width="461px"></asp:TextBox>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox3"  Display = "Dynamic" ErrorMessage="*Required" ForeColor="Red"></asp:RequiredFieldValidator>
...
<legend>
    ...
    <br />
            ...
            <asp:Button ID="Button1" runat="server" Text="Continue to seat selection" OnClick="Button1_Click" />
